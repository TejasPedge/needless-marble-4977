...
function CategoriesinFocus() {
  return (
    ...
    <Box mt = '1.5' border = '2px solid red'>

<Text color={useColorModeValue('black', 'white')} mb = '3' fontWeight={'600'} fontSize={'24px'}>Categories In Focus</Text>

          {/* scrollbar css is added in index.css */}

        <HStack className="scrollbar" overflowX={'scroll'} justify={'space-between'} mt = '4'>
